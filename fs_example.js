...
function writeFileExamples() {
    ...
    fs.writeFile("test.txt", "Just doing a little test", (err) => { // callback
    ...
    // Promise version
    fs_prom.writeFile("./test_dir/test_promise.txt", "Another test file blah").then(res => console.log("res of write_file promise", res))
...
function readFileExamples() {
    ...
    fs.readFile("./nums.txt", 'utf8', (err, nums) => console.log("callback version nums", nums, nums.split("\r\n")));
